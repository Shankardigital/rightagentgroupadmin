...
const Realestatefeatures = () => {
  ...
  const getAllbenners = async () => {
    const resonse = await addData("admin/realestate/features/getall")
    var _data = resonse
    setbanner(_data.data.feature)
  }

  const getAlltypes = async () => {
    const resonse = await addData("admin/realestate/getallactive", {})
    var _data = resonse
    settypes(_data.data.realestate)
  }
  ...
  const addbenners = async e => {
    ...
    // dataArray.append("realestateId", form.realestateId)
    for (let i = 0; i < Files.length; i++) {
      dataArray.append("featureImage", Files[i])
    }
    try {
      const resonse = await addData("admin/realestate/features/add", dataArray)
      var _data = resonse
      console.log(_data)
      toast.success(_data.data.message)
      setFiles({ featureImage: "" })
      setform({
        title: "",
        realestateId: "",
      })
  ...
  const editbenners = async e => {
    ...
    // dataArray.append("realestateId", form1.realestateId)
    ...
    try {
      const resonse = await addData(
        "admin/realestate/features/edit/" + form1._id,
        dataArray
      )
      var _data = resonse
      console.log(_data)
      toast.success(_data.data.message)
      setFiles1({ featureImage: "" })
      setform1({
        title: "",
        realestateId: "",
      })
  ...
  const deletebenners = async data => {
    try {
      const resonse = await deletedData(
        "admin/realestate/features/delete/" + data._id,
        {}
      )
      var _data = resonse
      console.log(_data)
  ...
  const handleSearch = async e => {
    const resonse = await addData(
      "admin/realestate/features/getall?searchQuery=" + e.target.value
    )
    var _data = resonse
    setbanner(_data.data.feature)
  }
      ...
      <div className="page-content">
        <Container fluid>
          ...
          <Breadcrumbs
            ...
            breadcrumbItem="Realestate Features"
          />
          ...
          <Row>
            <Col md={4}>
              <Card>
                <CardHeader className="bg-white">
                  <CardTitle>Add Realestate Feature</CardTitle>
                </CardHeader>
                <CardBody>
                  <Form
                    onSubmit={e => {
            ...
            <Col md={8}>
              <Card>
                <CardHeader className="bg-white">
                  <CardTitle>Realestate Feature List</CardTitle>
                </CardHeader>
