...
const AGENTPAYOUT = () => {
  ...
  const getAllCustomer = async () => {
    const resonse = await addData("admin/report/insurances")
    var _data = resonse
    setCustomer(_data.data.quoteInsurances)
    setCustomerexcl(_data.data.quoteInsurances)
  }

  const Customerearch = async (e) => {
    const resonse = await addData("admin/report/insurances?searchQuery=" + e.target.value)
    var _data = resonse
    setCustomer(_data.data.quoteInsurances)
  }
  ...
  const filterCustomer = async (e) => {
    ...
    const resonse = await addData("admin/report/insurancesfilter", bodydata)
    var _data = resonse
    setCustomer(_data.data.quoteInsurances)
    setshow(false)
  }
    ...
    <React.Fragment>
      <div className="page-content">
        <div className="container-fluid">
          <Breadcrumbs title="Right Agent Group" breadcrumbItem="Insurance" />
