...
const Customers = () => {
  ...
  const getAllCustomer = async () => {
    const resonse = await addData("admin/report/loan")
    var _data = resonse
    setCustomer(_data.data.quoteLoan)
    setCustomerexcl(_data.data.quoteLoan)
  }

  const Customerearch = async e => {
    const resonse = await addData(
      "admin/report/loan?searchQuery=" + e.target.value
    )
    var _data = resonse
    setCustomer(_data.data.quoteLoan)
  }
  ...
  const filterCustomer = async (e) => {
    ...
    const resonse = await addData("admin/report/loanfilter", bodydata)
    var _data = resonse
    setCustomer(_data.data.quoteLoan)
    setshow(false)
  }
    ...
    <React.Fragment>
      <div className="page-content">
        <div className="container-fluid">
          <Breadcrumbs title="Right Agent Group" breadcrumbItem="Loans" />
