...
const AGENTPAYOUT = () => {
  ...
  const getAllCustomer = async () => {
    const resonse = await addData("admin/report/realestate")
    var _data = resonse
    setCustomer(_data.data.quoteRealestate)
    setCustomerexcl(_data.data.quoteRealestate)
  }

  const Customerearch = async (e) => {
    const resonse = await addData("admin/report/realestate?searchQuery=" + e.target.value)
    var _data = resonse
    setCustomer(_data.data.quoteRealestate)
  }
  ...
  const filterCustomer = async (e) => {
    ...
    const resonse = await addData("admin/report/realestatefilter", bodydata)
    var _data = resonse
    setCustomer(_data.data.quoteRealestate)
    setshow(false)
  }
