...
const AGENTPAYOUT = () => {
  ...
  const getAllCustomer = async () => {
    const resonse = await addData("admin/eligibility/getall")
    var _data = resonse
    setCustomer(_data.data.eigibility)
    setCustomerexcl(_data.data.eigibility)
  }

  const Customerearch = async (e) => {
    const resonse = await addData("admin/eligibility/getall?searchQuery=" + e.target.value)
    var _data = resonse
    setCustomer(_data.data.eigibility)
  }
  ...
  const filterCustomer = async (e) => {
    ...
    const resonse = await addData("admin/eligibility/filter", bodydata)
    var _data = resonse
    setCustomer(_data.data.eigibility)
    setshow(false)
  }
    ...
    <React.Fragment>
      <div className="page-content">
        <div className="container-fluid">
          <Breadcrumbs title="Right Agent Group" breadcrumbItem="Get Eligibility List" />
