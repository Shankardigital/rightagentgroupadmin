          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/loans">
                ...
                <span>{props.t("Loans & Insurances")}</span>
              </Link> 
            </li>
            <li>
              <Link to="/realestate">
                <i className="bx bx-building-house"></i>
                <span>{props.t("Real Estate")}</span>
              </Link> 
            </li>

            <li>
              <Link to="/realestatefeatures">
                <i className="bx bx-share-alt"></i>
                <span>{props.t("Real Estate Features")}</span>
              </Link> 
            </li>
            ...
            <li>
              <Link to="/basic_details">
                <i className="bx bx-doughnut-chart"></i>
                <span>{props.t("Basic Detials")}</span>
              </Link>
            </li>
            <li>
              <Link to="/faq">
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/loan_reports">{props.t("Loan Lead Report")}</Link>
                </li>
                <li>
                  <Link to="/insurance_reports">
                    {props.t("Insurance Lead Report")}
                  </Link>
                </li>
                <li>
                  <Link to="/realestate_reports">{props.t("Real Estate Leads")}</Link>
                </li>
                <li>
                  <Link to="/insuranceform_reports">{props.t("Insurance Forms")}</Link>
                </li>
                <li>
                  <Link to="/geteligibility_reports">{props.t("Get Eligibility Forms")}</Link>
                </li>
              </ul>
            </li>
